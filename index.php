...
<body>
    <div class="input-box" style="width:auto;height:510px; text-align:center;">
        <button type="button" onclick="showForm('Management')" style="border-color: transparent;#1763a9;
        margin-top:40px;
    ...
    border-radius: 25px;
    height: 30px;   
    width: 150px; ">Management</button>
        <button type="button" onclick="showForm('Employee')" style="border-color: transparent;
    background-color: #1763a9;
    font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;
    font-size:larger;
    font-weight: bold;
    ...
    width: 150px;">Employee</button>
        ...
        <div id="employeeForm" style="display:none; border-radius: 25px; height:auto; text-align: center; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; background-color: rgb(0, 0, 0); margin-right: 30%; margin-left: 30%;">
            <form action="index.php" method="post">
