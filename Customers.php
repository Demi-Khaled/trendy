                ...
                <?php if (!empty($rows)) : ?>
                    <?php foreach ($rows as $row) : ?>
                        <tr>
                            ...
                            <td>
                                <button class="edit-btn" data-id="<?php echo htmlspecialchars($row['customerid']); ?>" style="background:#1d5488; color:aliceblue; font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; width:50px; border-radius:25px; border-color:transparent;cursor:pointer;">Edit</button>
                                <button class="delete-btn" data-id="<?php echo htmlspecialchars($row['customerid']); ?>" style="background:#1d5488; color:aliceblue; font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; width:60px; border-radius:25px; border-color:transparent;cursor:pointer;">Delete</button>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                <?php else : ?>
